...
@Component({
    selector: 'app-topbar',
    standalone: true,
    imports: [RouterModule, CommonModule, StyleClassModule, ButtonModule, MenuModule, DropdownModule, AppConfigurator],
        ...
        <div class="layout-topbar-actions">
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <!-- Profile Section -->
                    <div *ngIf="currentUser; else loginButton" class="relative">
                        <button 
                            class="layout-topbar-action profile-trigger"
                            (click)="toggleProfileMenu()"
                            aria-label="Profile menu">
                            <i class="pi pi-user"></i>
                            <span>{{ currentUser.username }}</span>
                            <i class="pi pi-chevron-down" [class.pi-chevron-up]="showProfileMenu"></i>
                        </button>
                        <div class="profile-dropdown-menu" *ngIf="showProfileMenu">
                            ...
                            <div class="profile-dropdown-item logout-item" (click)="logout()">
